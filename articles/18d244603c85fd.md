...
# あとがき
いいたい事
- [x] dduの一部分の紹介記述なので、自分の知らない機能も多そう
- [x] 他のffも試してみて良さそうな機能をdduで設定として再現するのも良さそう
- [x] vimscript・lua・typescriptで設定できるらしい
- [x] dppもあるし、早めに他のプラグインマネージャも触っておきたいな
- [x] 自分の設定例はdotfilesで公開してるので勝手に取っていってね
